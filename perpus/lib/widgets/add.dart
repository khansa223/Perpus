        ...
        child: Dialog(
          ...
          child: Container(
            ...
            child: GestureDetector(
              onTap: () {}, // Prevent closing the dialog when tapping inside
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(
                    ...
                    onChanged: (value) {
                      setState(() {
                        titleError = null; // Reset error when user types
                      });
                    },
                  ),
                  _buildTextField(
                    ...
                    onChanged: (value) {
                      setState(() {
                        descriptionError = null; // Reset error when user types
                      });
                    },
                  ),
                  _buildTextField(
                    ...
                    onChanged: (value) {
                      setState(() {
                        authorError = null; // Reset error when user types
                      });
                    },
                  ),
                  _buildTextField(
                    ...
                    onChanged: (value) {
                      setState(() {
                        publisherError = null; // Reset error when user types
                      });
                    },
                  ),
                  _buildTextField(
                    ...
                    onChanged: (value) {
                      setState(() {
                        stockError = null; // Reset error when user types
                      });
                    },
                  ),
                  _buildTextField(
                    ...
                    onChanged: (value) {
                      setState(() {
                        imageUrlError = null; // Reset error when user types
                      });
                    },
                  ),
                  const SizedBox(height: 16),
